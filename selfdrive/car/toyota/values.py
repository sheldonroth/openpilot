...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    ...
    Ecu.engine: [CAR.CAMRY, CAR.COROLLA_TSS2, CAR.CHR, CAR.CHR_TSS2, CAR.LEXUS_IS, CAR.LEXUS_RC, CAR.LEXUS_RC_2017],
  }
)
...
DBC = {
  ...
  CAR.LEXUS_RC_2017: dbc_dict('toyota_tnga_k_pt_generated', 'toyota_adas'),
